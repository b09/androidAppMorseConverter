...
public class AlphaToHebrewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_alpha_to_hebrew);
        ...
        convert.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String tranlatedText = MorseAlphaTranslator.alphaToHebrew(untranslatedText);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == R.id.nav_home) {
            Intent intent = new Intent(AlphaToHebrewActivity.this, HomeActivity.class);
